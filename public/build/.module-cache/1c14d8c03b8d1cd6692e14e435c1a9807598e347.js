var Tour=React.createClass({displayName: "Tour",
  render: function() {
    ...
    var urlBook="http://admin.lomastravel.com/tours/cancun.html";
    return (
      React.createElement("div", {className: "card row"}, 
        ...
        React.createElement("div", {className: "col s12 m4 l4"}, 
        	...
        	React.createElement("div", {className: "col s10 offset-s1 m8 offset-m2 l6 offset-l3"}, 
        		React.createElement("a", {href: urlBook, className: "btn red"}, 
        			"BOOK"
        		)
        	)	
        )
