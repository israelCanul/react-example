...
var data = [{ 'nom': 'Park tour royale', 'desc': 'esta es la descripcion del tour', 'img': 'img/imagen.jpg', 'dest': 'cancun', 'precio': '12', 'currency': 'USD' }, { 'nom': 'BOnanza', 'desc': 'este es el tour de bonanza', 'img': 'img/imagen.jpg', 'dest': 'Puertomorelos', 'precio': '24', 'currency': 'USD' }];
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            'a',
            { href: urlBook, className: 'col s12 btn red' },
            'BOOK'
          )
        )
      )
...
React.render(React.createElement(ListTours, { data: data }), document.getElementById('elemento'));